...
const ContactUsModal=() => {
  ...
  return (
    <div className="flex">
      <button className=" w-[150px]  xxl:w-[216px] h-9 xxl:h-[48px]  flex items-center justify-center border border-transparent hover:border-gray-200 text-white bg-[#ff0000] hover:bg-transparent rounded-md"
        onClick={openModal}
      >
        Contact Us
      </button>
              ...
              <div className="flex relative justify-center text-left align-middle transition-all transform bg-[#5b3866] rounded-md w-1/3 2xl:w-[525px] m-auto">
                ...
                <div className="relative w-8/12 mt-8 xl:mt-10 2xl:mt-16 mb-10 xl:mb-12 2xl:mb-16">
                  ...
                  <div className="w-full justify-center mt-2 xl:mt-3 2xl:mt-4">
                    <button className=" flex w-full h-[34px] items-center justify-center text-white text-base border border-transparent hover:border-gray-200 bg-[#ff0000] hover:bg-transparent rounded-md"
                      onClick={sendClick}
                    >
                      Send
                    </button>

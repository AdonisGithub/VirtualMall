  ...
  return (
    <div>
      ...
      <div className="blolck w-full">
            <div className="background_seller1 lg:h-screen grid justify-items-start w-screen ">
                <div className="flex items-center">
                    <div className="w-3/4 lg:w-1/2 ml-[12%] lg:ml-[80px]">
                        <div className=" text-[30px] 2xl:text-[80px] leading-tight  font-bold font-sans tracking-wide mb-6">
                        ...
                        <div className="w-full flex gap-[18px] mb-12">
            ...
            <div className="lg:h-screen grid justify-items-end w-screen background_seller2">

...
const SignupPage = () => {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    setSubmitted(true);
    if(user.password !== user.passwordConfirm) Toast("","Match Password and Confirm Password!","warning");
    else
    if(user.fullName && user.lastName && user.userName && user.email && user.password && phoneNumber){
            ...
            <div className="">
              ...
              <div className="w-full 2xl:w-[369px] lg:w-[320px]  m-auto">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                {submitted && !user.email &&<div className="text-sm text-amber-600" >Email Address is required</div>}
              </div>
              <div className="w-full 2xl:w-[369px] lg:w-[320px]  m-auto">

...
const SellerSignupPage = () => {
  ...
  const handleSellerRegister = (e) => {
    e.preventDefault();
    setSubmitted(true);
    if(seller.password !== seller.passwordConfirm) Toast("","Match Password and Confirm Password!","warning");
    else
          ...
          <div className="flex w-full md:w-1/2 justify-center items-center  lg:mt-[95px] mx-16 z-10">
            <div className="w-full h-full flex items-center justify-center ">
              <div className="">
                ...
                <div className="w-full 2xl:w-[369px] lg:w-[320px]  m-auto">
                  <button
                    className=" flex w-full h-[34px] mt-5 mb-10 items-center justify-center text-white lg:hover:text-black text-base border border-transparent hover:border-black bg-[#ff0000] hover:bg-transparent rounded-md"
